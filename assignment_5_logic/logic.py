...
class And(BinaryFormula):
    ...
    def truthValue(self, truthDict):
        ...
        '''if(temp1==TrueConstant and temp2==TrueConstant):
            return True
        elif(temp1==TrueConstant and truthDict[temp2]==True):
            return True
        elif(truthDict[temp1]==True and temp2==TrueConstant):
            return True
        elif(truthDict[temp1]==True and truthDict[temp2]==True):
            return True
        else:
            return False'''
        
        return truthValue(temp1,truthDict) and truthValue(temp2,truthDict)           
...
class Or(BinaryFormula):
    ...
    def toCNF(self):
        ...
        return Not(And(Not(temp1),Not(temp2)))
    ...
    def truthValue(self, truthDict):
        ...
        '''if(temp1==FalseConstant and temp2==FalseConstant):
            return False
        elif(temp1==FalseConstant and truthDict[temp2]==False):
            return False
        elif(truthDict[temp1]==False and temp2==FasleConstant):
            return False
        elif(truthDict[temp1]==False and truthDict[temp2]==False):
            return False
        else:
            return True'''
        return temp1.truthValue() or temp2.truthValue()
        #return None
...
class Not(Formula):
    ...
    def truthValue(self, truthDict):
        ...
        '''if(temp==TrueConstant):
            return False
        elif(truthDict[temp]==True):
            return False
        elif(temp==FalseConstant):
            return True
        else:
            return True'''
        if truthDict[temp]==TrueConstant:
            return "False"
        else:
            return "True"
...
def Equivalence(arg1, arg2):
    ...
    return Or(And(Not(arg1),Not(arg2)),And(arg1,arg2))
